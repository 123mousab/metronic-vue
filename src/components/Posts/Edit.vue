<template>
  <div>
    <form @submit.prevent="updatePost(post)" data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
        ...
        <div class="card-body pt-0">
          ...
          <div class="mb-10 fv-row fv-plugins-icon-container">
            ...
            <div class="fv-plugins-message-container invalid-feedback">
              <div data-validator="notEmpty" v-for="message in validationErrors?.title">
                {{ message }}
              </div>
            </div>
            <!--end::Input-->
          ...
          <div class="mb-10 fv-row fv-plugins-icon-container">
            ...
            <div class="fv-plugins-message-container invalid-feedback">
              <div data-validator="notEmpty" v-for="message in validationErrors?.content">
                {{ message }}
              </div>
            </div>
            <!--end::Input-->
          ...
          <div class="mb-10 fv-row fv-plugins-icon-container">
            ...
            <div class="form-floating border rounded">
              ...
              <div class="fv-plugins-message-container invalid-feedback">
                <div  data-validator="notEmpty" v-for="message in validationErrors?.category_id">
                  {{ message }}
                </div>
              </div>
              <!--end::Select2-->
